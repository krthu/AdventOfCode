def score(elf1, elf2):
    ...
    if (elf1Start <= elf2Start and elf1End >= elf2Start 
        or elf1Start <= elf2End and elf1End >= elf2End
        or elf2Start <= elf1Start and elf2End >= elf1Start 
        or elf2Start <= elf1End and elf2End >= elf1End): 
        points += 1
    print(points)
    return points
